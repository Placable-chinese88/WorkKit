...
struct TSP_DatabaseData: Sendable {
...
struct TSP_DatabaseDataArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSP_DatabaseImageDataArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  enum ImageType: Int, SwiftProtobuf.Enum, Swift.CaseIterable {
    case unknown = 0
    case bitmap = 1
    case pdf = 2
...
extension TSP_DatabaseDataArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}data\0\u{3}app_relative_path\0\u{3}display_name\0\u{1}length\0\u{1}hash\0\u{1}sharable\0")
...
extension TSP_DatabaseImageDataArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}super\0\u{1}type\0")
...
extension TSP_DatabaseImageDataArchive.ImageType: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0unknown\0\u{1}bitmap\0\u{1}pdf\0")
}
