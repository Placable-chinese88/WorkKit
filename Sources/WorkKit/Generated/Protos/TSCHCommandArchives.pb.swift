...
enum TSCH_StyleOwnerType: Int, SwiftProtobuf.Enum, Swift.CaseIterable {
  case chartInfo = 1
  case legendModel = 2
  case chartAxis = 3
  case chartSeries = 4
...
enum TSCH_StyleSwapType: Int, SwiftProtobuf.Enum, Swift.CaseIterable {
  case chartStyle = 1
...
enum TSCH_ApplyPresetBehavior: Int, SwiftProtobuf.Enum, Swift.CaseIterable {
...
struct TSCH_StyleOwnerPath: Sendable {
...
struct TSCH_CommandSetChartTypeArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSCH_StyleSwapUndoTupleArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSCH_StyleSwapUndoTuplesArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSCH_CommandStyleSwapArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSCH_CommandMutatePropertiesArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  struct GenericPropertyDeltaMap: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    struct GenericMapUnion: @unchecked Sendable {
      // SwiftProtobuf.Message conformance is added in an extension below. See the
      // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
      // methods supported on all messages.
      ...
      var hasChartMap: Bool {return _storage._chartMap != nil}
      /// Clears the value of `chartMap`. Subsequent reads from it will return its default value.
      mutating func clearChartMap() {_uniqueStorage()._chartMap = nil}
      ...
      var hasLegendMap: Bool {return _storage._legendMap != nil}
      /// Clears the value of `legendMap`. Subsequent reads from it will return its default value.
      mutating func clearLegendMap() {_uniqueStorage()._legendMap = nil}
      ...
      var hasAxisMap: Bool {return _storage._axisMap != nil}
      /// Clears the value of `axisMap`. Subsequent reads from it will return its default value.
      mutating func clearAxisMap() {_uniqueStorage()._axisMap = nil}
      ...
      var hasSeriesMap: Bool {return _storage._seriesMap != nil}
      /// Clears the value of `seriesMap`. Subsequent reads from it will return its default value.
      mutating func clearSeriesMap() {_uniqueStorage()._seriesMap = nil}
      ...
      var hasReferenceLineMap: Bool {return _storage._referenceLineMap != nil}
      /// Clears the value of `referenceLineMap`. Subsequent reads from it will return its default value.
      mutating func clearReferenceLineMap() {_uniqueStorage()._referenceLineMap = nil}
  ...
  struct ParagraphStyleDeltaMap: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    struct ParagraphStylePropertyMapArchive: Sendable {
      // SwiftProtobuf.Message conformance is added in an extension below. See the
      // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
      // methods supported on all messages.
...
struct TSCH_CommandScaleAllTextArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSCH_CommandSetFontFamilyArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  struct StyleSemanticTag: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  struct SemanticParagraphStyleMutationMap: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
struct TSCH_CommandApplyFillSetArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSCH_CommandSetSeriesNameArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSCH_CommandSetCategoryNameArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSCH_CommandAddGridRowsArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSCH_CommandAddGridColumnsArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSCH_CommandMoveGridRowsArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSCH_CommandMoveGridColumnsArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSCH_CommandDeleteGridRowsArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSCH_CommandDeleteGridColumnsArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSCH_CommandSetGridValueArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSCH_CommandSetGridDirectionArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSCH_CommandSetSeriesTypeArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSCH_CommandSetScatterFormatArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSCH_CommandSetMultiDataSetIndexArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSCH_CommandSetLegendFrameArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSCH_CommandSetPieWedgeExplosion: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSCH_CommandChartApplyTheme: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var hasSwapCommand: Bool {return _storage._swapCommand != nil}
  /// Clears the value of `swapCommand`. Subsequent reads from it will return its default value.
  mutating func clearSwapCommand() {_uniqueStorage()._swapCommand = nil}
...
struct TSCH_CommandChartApplyPreset: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSCH_CommandCleanupGeometryArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSCH_ChartCommandArchive: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  /// Returns true if `chartInfo` has been explicitly set.
  var hasChartInfo: Bool {return _storage._chartInfo != nil}
  /// Clears the value of `chartInfo`. Subsequent reads from it will return its default value.
  mutating func clearChartInfo() {_uniqueStorage()._chartInfo = nil}
  ...
  var hasOriginalDirtyState: Bool {return _storage._originalDirtyState != nil}
  /// Clears the value of `originalDirtyState`. Subsequent reads from it will return its default value.
  mutating func clearOriginalDirtyState() {_uniqueStorage()._originalDirtyState = nil}
  ...
  var hasChartInfoIDPath: Bool {return _storage._chartInfoIDPath != nil}
  /// Clears the value of `chartInfoIDPath`. Subsequent reads from it will return its default value.
  mutating func clearChartInfoIDPath() {_uniqueStorage()._chartInfoIDPath = nil}
  ...
  var hasIsForForwardUndoRedo: Bool {return _storage._isForForwardUndoRedo != nil}
  /// Clears the value of `isForForwardUndoRedo`. Subsequent reads from it will return its default value.
  mutating func clearIsForForwardUndoRedo() {_uniqueStorage()._isForForwardUndoRedo = nil}
...
struct TSCH_CommandReplaceGridValuesArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSCH_CommandReplaceThemePresetArchive: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var hasNewPreset: Bool {return _storage._newPreset != nil}
  /// Clears the value of `newPreset`. Subsequent reads from it will return its default value.
  mutating func clearNewPreset() {_uniqueStorage()._newPreset = nil}
  ...
  var hasOldPresetIndex: Bool {return _storage._oldPresetIndex != nil}
  /// Clears the value of `oldPresetIndex`. Subsequent reads from it will return its default value.
  mutating func clearOldPresetIndex() {_uniqueStorage()._oldPresetIndex = nil}

  var unknownFields = SwiftProtobuf.UnknownStorage()

  struct StyleAndIdentifierPair: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
struct TSCH_CommandInvalidateWPCaches: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSCH_CommandReplaceCustomFormatArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  struct FormatObjectMutation: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
struct TSCH_CommandAddReferenceLineArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSCH_CommandDeleteReferenceLineArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSCH_CommandPasteStyleArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSCH_CommandReplaceImageDataArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSCH_CommandInducedReplaceChartGrid: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSCH_CommandInduced3DChartGeometry: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSCH_ChartTextSelectionTransformerArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSCH_ChartDrawableSelectionTransformerArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSCH_ChartSubselectionTransformerHelperArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSCH_ChartRefLineSubselectionTransformerHelperArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSCH_ChartSubselectionIdentityTransformerHelperArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSCH_ChartSubselectionTransformerArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSCH_CDESelectionTransformerArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension TSCH_StyleOwnerType: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}chart_info\0\u{1}legend_model\0\u{1}chart_axis\0\u{1}chart_series\0\u{1}reference_line\0")
}
...
extension TSCH_ApplyPresetBehavior: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}remove_overrides\0\u{1}preserve_overrides\0\u{1}preserve_appearance\0")
}
...
extension TSCH_StyleSwapUndoTupleArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}chart_info\0\u{3}swap_type\0\u{1}index\0\u{3}old_value\0\u{3}new_value\0\u{3}ref_line_uuid\0")
...
extension TSCH_StyleSwapUndoTuplesArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}swap_tuples\0")
...
extension TSCH_CommandStyleSwapArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}super\0\u{3}undo_tuples\0")
...
extension TSCH_CommandMutatePropertiesArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}super\0\u{3}rollback_cmd\0\u{3}generic_property_delta_maps\0\u{3}paragraph_style_delta_maps\0\u{1}initiatedOnWeb\0")
...
extension TSCH_CommandMutatePropertiesArchive.GenericPropertyDeltaMap: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}style_owner_path\0\u{3}forward_map\0\u{3}reverse_map\0")
...
extension TSCH_CommandMutatePropertiesArchive.GenericPropertyDeltaMap.GenericMapUnion: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{4}\u{2}chart_map\0\u{3}legend_map\0\u{3}axis_map\0\u{3}series_map\0\u{3}reference_line_map\0")
...
extension TSCH_CommandMutatePropertiesArchive.ParagraphStyleDeltaMap: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}style_owner_path\0\u{3}paragraph_style_index_property\0\u{3}forward_map\0\u{3}reverse_map\0")
...
extension TSCH_CommandMutatePropertiesArchive.ParagraphStyleDeltaMap.ParagraphStylePropertyMapArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}char_properties\0\u{3}para_properties\0")
...
extension TSCH_CommandScaleAllTextArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}super\0\u{3}rollback_cmd\0\u{3}scale_factor\0")
...
extension TSCH_CommandSetFontFamilyArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}super\0\u{3}rollback_cmd\0\u{3}new_font_family\0\u{3}old_font_family\0\u{3}paragraph_style_delta_maps\0\u{3}is_bold\0\u{3}is_italic\0")
...
extension TSCH_CommandSetFontFamilyArchive.StyleSemanticTag: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}swap_type\0\u{1}index\0")
...
extension TSCH_CommandSetFontFamilyArchive.SemanticParagraphStyleMutationMap: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}style_semantic_tag\0\u{3}paragraph_style_index_property\0\u{3}forward_map\0\u{3}reverse_map\0")
...
extension TSCH_CommandApplyFillSetArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}super\0\u{3}chart_type\0\u{3}fill_set\0\u{3}old_fill_set\0\u{3}prior_last_applied_fill_set_lookup_string\0\u{3}rollback_cmd\0")
...
extension TSCH_CommandSetSeriesNameArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}super\0\u{1}seriesIndex\0\u{1}oldName\0\u{1}newName\0")
...
extension TSCH_CommandSetCategoryNameArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}super\0\u{1}categoryIndex\0\u{1}oldName\0\u{1}newName\0\u{1}isMultiDataIndex\0")
...
extension TSCH_CommandAddGridRowsArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}super\0\u{3}row_id\0\u{3}row_id_list\0\u{3}row_name_list\0\u{3}undo_deletion_start_id\0\u{3}undo_deletion_end_id\0")
...
extension TSCH_CommandAddGridColumnsArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}super\0\u{3}column_id\0\u{3}column_id_list\0\u{3}column_name_list\0\u{3}undo_deletion_start_id\0\u{3}undo_deletion_end_id\0")
...
extension TSCH_CommandMoveGridRowsArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}super\0\u{3}start_row_id\0\u{3}end_row_id\0\u{3}after_row_id\0\u{3}undo_after_row_id\0")
...
extension TSCH_CommandMoveGridColumnsArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}super\0\u{3}start_column_id\0\u{3}end_column_id\0\u{3}after_column_id\0\u{3}undo_after_column_id\0")
...
extension TSCH_CommandSetGridValueArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}super\0\u{1}rowindex\0\u{1}columnindex\0\u{1}oldvalue\0\u{1}newvalue\0")
...
extension TSCH_CommandSetGridDirectionArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}super\0\u{3}old_direction\0\u{3}new_direction\0")
...
extension TSCH_CommandSetSeriesTypeArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}super\0\u{1}seriesindex\0\u{1}oldtype\0\u{1}newtype\0")
...
extension TSCH_CommandSetScatterFormatArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}super\0\u{2}\u{2}oldformat\0\u{1}newformat\0")
...
extension TSCH_CommandSetMultiDataSetIndexArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}super\0\u{1}oldindex\0\u{1}newindex\0")
...
extension TSCH_CommandSetLegendFrameArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}super\0\u{3}old_legend_frame\0\u{3}new_legend_frame\0")
...
extension TSCH_CommandSetPieWedgeExplosion: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}super\0\u{3}series_indices\0\u{3}wedge_explosions\0\u{4}\u{2}old_series_indices\0\u{3}old_wedge_explosions\0\u{3}rollback_cmd\0")
...
extension TSCH_CommandChartApplyTheme: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}super\0\u{1}info\0\u{3}swap_command\0\u{1}preset\0")
...
extension TSCH_CommandChartApplyPreset: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}super\0\u{1}behavior\0\u{1}preset\0\u{3}old_preset\0\u{3}should_apply_swap_tuples\0\u{3}are_swap_tuples_valid\0\u{3}swap_tuples\0\u{3}inverse_swap_tuples\0\u{3}rollback_preset\0\u{3}rollback_swap_tuples\0")
...
extension TSCH_CommandCleanupGeometryArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}super\0\u{3}info_geometry_command\0\u{3}anchor_attachment_command\0\u{3}original_legend_rect\0")
...
extension TSCH_ChartCommandArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}super\0\u{3}chart_info\0\u{3}original_dirty_state\0\u{3}chart_info_id_path\0\u{3}is_for_forward_undo_redo\0")
...
extension TSCH_CommandReplaceThemePresetArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}super\0\u{1}theme\0\u{3}old_preset\0\u{3}new_preset\0\u{1}identifiers\0\u{3}old_preset_index\0")
...
extension TSCH_CommandReplaceThemePresetArchive.StyleAndIdentifierPair: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}style\0\u{1}identifier\0")
...
extension TSCH_CommandReplaceCustomFormatArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}super\0\u{3}rollback_cmd\0\u{3}old_format_object\0\u{3}new_format_object\0\u{3}forward_mutations\0\u{3}reverse_mutations\0")
...
extension TSCH_CommandReplaceCustomFormatArchive.FormatObjectMutation: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}style_owner_type\0\u{3}style_owner_index\0\u{3}format_object_property\0\u{3}format_object\0")
...
extension TSCH_CommandAddReferenceLineArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}super\0\u{3}axis_id\0\u{1}uuid\0\u{3}non_style\0\u{1}style\0\u{3}paragraph_styles\0\u{3}rollback_commands\0")
...
extension TSCH_CommandDeleteReferenceLineArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}super\0\u{3}axis_id\0\u{1}uuid\0\u{3}non_style\0\u{1}style\0\u{3}paragraph_styles\0\u{3}style_swap_command\0")
...
extension TSCH_CommandPasteStyleArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}super\0\u{3}style_swap_command\0\u{3}inverse_chart_style_state\0\u{3}chart_style_state\0\u{3}shape_style\0\u{1}subselection\0")
...
extension TSCH_CommandReplaceImageDataArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}super\0\u{3}style_swap_command\0\u{3}inverse_chart_style_state\0\u{3}chart_style_state\0")
...
extension TSCH_ChartTextSelectionTransformerArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}selection\0")
...
extension TSCH_ChartRefLineSubselectionTransformerHelperArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}super\0\u{3}selected_reference_line_uuids\0")
...
extension TSCH_ChartSubselectionTransformerArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}selection\0\u{1}helper\0")
...
extension TSCH_CDESelectionTransformerArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}cde_selection\0")
