...
struct TSCH_PreUFF_ChartInfoArchive: @unchecked Sendable {
...
struct TSCH_PreUFF_LegendModelArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSCH_PreUFF_ChartModelArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSCH_PreUFF_ChartGridArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSCH_PreUFF_ChartsNumberFormatArchive: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSCH_PreUFF_ChartStyleArchive: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var tschchartinfodefaultdeprecatedmainfontfamily: String {
  ...
  var hasTschchartinfodefaultdeprecatedmainfontfamily: Bool {return _storage._tschchartinfodefaultdeprecatedmainfontfamily != nil}
  /// Clears the value of `tschchartinfodefaultdeprecatedmainfontfamily`. Subsequent reads from it will return its default value.
  mutating func clearTschchartinfodefaultdeprecatedmainfontfamily() {_uniqueStorage()._tschchartinfodefaultdeprecatedmainfontfamily = nil}

  var tschchartinfodefaultdeprecatedmainfontnamedsize: Int32 {
  ...
  var hasTschchartinfodefaultdeprecatedmainfontnamedsize: Bool {return _storage._tschchartinfodefaultdeprecatedmainfontnamedsize != nil}
  ...
  mutating func clearTschchartinfodefaultdeprecatedmainfontnamedsize() {_uniqueStorage()._tschchartinfodefaultdeprecatedmainfontnamedsize = nil}
...
struct TSCH_PreUFF_ChartNonStyleArchive: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var tschchartinfodefaultdeprecatedagainmainfontnamedsize: Int32 {
  ...
  var hasTschchartinfodefaultdeprecatedagainmainfontnamedsize: Bool {return _storage._tschchartinfodefaultdeprecatedagainmainfontnamedsize != nil}
  ...
  mutating func clearTschchartinfodefaultdeprecatedagainmainfontnamedsize() {_uniqueStorage()._tschchartinfodefaultdeprecatedagainmainfontnamedsize = nil}
...
struct TSCH_PreUFF_LegendStyleArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSCH_PreUFF_LegendNonStyleArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSCH_PreUFF_ChartAxisStyleArchive: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSCH_PreUFF_ChartAxisNonStyleArchive: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSCH_PreUFF_ChartSeriesStyleArchive: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSCH_PreUFF_ChartSeriesNonStyleArchive: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension TSCH_PreUFF_LegendModelArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}info\0\u{1}frame\0\u{1}style\0\u{3}non_style\0")
...
extension TSCH_PreUFF_ChartModelArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}info\0\u{1}grid\0\u{3}series_types\0\u{3}scatter_format\0\u{3}inline_grid\0\u{3}multidataset_index\0")
...
extension TSCH_PreUFF_ChartGridArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}direction\0\u{3}row_name\0\u{3}column_name\0\u{3}value_row\0\u{2}\u{2}dirty\0")
...
extension TSCH_PreUFF_LegendStyleArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}super\0\u{2}\u{9}tschlegendmodeldefaultfill\0\u{1}tschlegendmodeldefaultstroke\0\u{2}\u{3}tschlegendmodeldefaultshadow\0\u{1}tschlegendmodeldefaultopacity\0\u{1}tschlegendmodeldefaultlabelparagraphstyleindex\0")
