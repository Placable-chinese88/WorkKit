...
struct TSWPSOS_SpecSetCharacterStyleArchive: Sendable {
...
struct TSWPSOS_SpecSetColumnsArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSWPSOS_SpecSetDropCapArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSWPSOS_SpecSetFontFeaturesArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSWPSOS_SpecSetLineSpacingArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSWPSOS_SpecSetListStyleArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSWPSOS_SpecSetListStyleBoolArrayArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSWPSOS_SpecSetListStyleFloatArrayArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSWPSOS_SpecSetListStyleImageDataArrayArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSWPSOS_SpecSetListStyleListLabelGeometryArrayArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSWPSOS_SpecSetListStyleListLabelTypeArrayArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSWPSOS_SpecSetListStyleListNumberTypeArrayArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSWPSOS_SpecSetListStyleStringArrayArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSWPSOS_SpecSetPaddingArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSWPSOS_SpecSetParagraphStyleArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSWPSOS_SpecSetRuleOffsetArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSWPSOS_SpecSetTabsArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSWPSOS_SpecCharacterStyleArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var specSetCharacterStyle: TSWPSOS_SpecSetCharacterStyleArchive {
...
struct TSWPSOS_SpecColumnsArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var specSetColumns: TSWPSOS_SpecSetColumnsArchive {
...
struct TSWPSOS_SpecDropCapArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var specSetDropCap: TSWPSOS_SpecSetDropCapArchive {
...
struct TSWPSOS_SpecFontFeaturesArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var specSetFontFeatures: TSWPSOS_SpecSetFontFeaturesArchive {
...
struct TSWPSOS_SpecLineSpacingArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var specSetLineSpacing: TSWPSOS_SpecSetLineSpacingArchive {
...
struct TSWPSOS_SpecListStyleArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var specSetListStyle: TSWPSOS_SpecSetListStyleArchive {
...
struct TSWPSOS_SpecListStyleBoolArrayArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var specSetListStyleBoolArray: TSWPSOS_SpecSetListStyleBoolArrayArchive {
...
struct TSWPSOS_SpecListStyleFloatArrayArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var specSetListStyleFloatArray: TSWPSOS_SpecSetListStyleFloatArrayArchive {
...
struct TSWPSOS_SpecListStyleImageDataArrayArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var specSetListStyleImageDataArray: TSWPSOS_SpecSetListStyleImageDataArrayArchive {
...
struct TSWPSOS_SpecListStyleListLabelGeometryArrayArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var specSetListStyleListLabelGeometryArray: TSWPSOS_SpecSetListStyleListLabelGeometryArrayArchive {
...
struct TSWPSOS_SpecListStyleListLabelTypeArrayArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var specSetListStyleListLabelTypeArray: TSWPSOS_SpecSetListStyleListLabelTypeArrayArchive {
...
struct TSWPSOS_SpecListStyleListNumberTypeArrayArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var specSetListStyleListNumberTypeArray: TSWPSOS_SpecSetListStyleListNumberTypeArrayArchive {
...
struct TSWPSOS_SpecListStyleStringArrayArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var specSetListStyleStringArray: TSWPSOS_SpecSetListStyleStringArrayArchive {
...
struct TSWPSOS_SpecPaddingArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var specSetPadding: TSWPSOS_SpecSetPaddingArchive {
...
struct TSWPSOS_SpecParagraphStyleArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var specSetParagraphStyle: TSWPSOS_SpecSetParagraphStyleArchive {
...
struct TSWPSOS_SpecRuleOffsetArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var specSetRuleOffset: TSWPSOS_SpecSetRuleOffsetArchive {
...
struct TSWPSOS_SpecTabsArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var specSetTabs: TSWPSOS_SpecSetTabsArchive {
...
struct TSWPSOS_CharacterStylePropertyChangeSetArchive: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var baselineShift: TSSSOS_SpecDoubleArchive {
  ...
  var capitalization: TSSSOS_SpecIntegerArchive {
  ...
  var compatibilityFontName: TSSSOS_SpecStringArchive {
  ...
  var emphasisMarks: TSSSOS_SpecStringArchive {
  ...
  var bold: TSSSOS_SpecBoolArchive {
  ...
  var italic: TSSSOS_SpecBoolArchive {
  ...
  var fontFeatures: TSWPSOS_SpecFontFeaturesArchive {
  ...
  var fontName: TSSSOS_SpecStringArchive {
  ...
  var fontSize: TSSSOS_SpecDoubleArchive {
  ...
  var fontSizeDelta: TSSSOS_SpecDoubleArchive {
  ...
  var kerning: TSSSOS_SpecDoubleArchive {
  ...
  var language: TSSSOS_SpecStringArchive {
  ...
  var ligatures: TSSSOS_SpecIntegerArchive {
  ...
  var textShadow: TSDSOS_SpecShadowArchive {
  ...
  var strikethruColor: TSSSOS_SpecColorArchive {
  ...
  var strikethru: TSSSOS_SpecIntegerArchive {
  ...
  var strikethruWidth: TSSSOS_SpecDoubleArchive {
  ...
  var superscript: TSSSOS_SpecIntegerArchive {
  ...
  var textBackground: TSSSOS_SpecColorArchive {
  ...
  var tracking: TSSSOS_SpecDoubleArchive {
  ...
  var underlineColor: TSSSOS_SpecColorArchive {
  ...
  var underline: TSSSOS_SpecIntegerArchive {
  ...
  var underlineWidth: TSSSOS_SpecDoubleArchive {
  ...
  var wordStrikethru: TSSSOS_SpecBoolArchive {
  ...
  var wordUnderline: TSSSOS_SpecBoolArchive {
  ...
  var writingDirection: TSSSOS_SpecIntegerArchive {
  ...
  var isNamedPointSize: TSSSOS_SpecBoolArchive {
  ...
  var capitalizationUsesLinguistics: TSSSOS_SpecBoolArchive {
  ...
  var characterStroke: TSDSOS_SpecStrokeArchive {
  ...
  var characterFill: TSDSOS_SpecFillArchive {
  ...
  var characterFillShouldFillTextContainer: TSSSOS_SpecBoolArchive {
...
struct TSWPSOS_ColumnStylePropertyChangeSetArchive: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var columns: TSWPSOS_SpecColumnsArchive {
  ...
  var continuous: TSSSOS_SpecBoolArchive {
  ...
  var margins: TSWPSOS_SpecPaddingArchive {
  ...
  var minHorizontalInset: TSSSOS_SpecDoubleArchive {
  ...
  var padding: TSWPSOS_SpecPaddingArchive {
  ...
  var shrinkToFit: TSSSOS_SpecBoolArchive {
  ...
  var verticalAlignment: TSSSOS_SpecIntegerArchive {
  ...
  var verticalText: TSSSOS_SpecBoolArchive {
...
struct TSWPSOS_DropCapSpecificStylePropertyChangeSetArchive: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var dropCapModel: TSWPSOS_SpecDropCapArchive {
  ...
  var hasDropCapModel: Bool {return _storage._dropCapModel != nil}
  /// Clears the value of `dropCapModel`. Subsequent reads from it will return its default value.
  mutating func clearDropCapModel() {_uniqueStorage()._dropCapModel = nil}
  ...
  var hasDropCapModelUndefined: Bool {return _storage._dropCapModelUndefined != nil}
  /// Clears the value of `dropCapModelUndefined`. Subsequent reads from it will return its default value.
  mutating func clearDropCapModelUndefined() {_uniqueStorage()._dropCapModelUndefined = nil}

  var dropCapShapeStroke: TSDSOS_SpecStrokeArchive {
  ...
  var hasDropCapShapeStrokeUndefined: Bool {return _storage._dropCapShapeStrokeUndefined != nil}
  /// Clears the value of `dropCapShapeStrokeUndefined`. Subsequent reads from it will return its default value.
  mutating func clearDropCapShapeStrokeUndefined() {_uniqueStorage()._dropCapShapeStrokeUndefined = nil}

  var dropCapShapeFill: TSDSOS_SpecFillArchive {
  ...
  var hasDropCapShapeFillUndefined: Bool {return _storage._dropCapShapeFillUndefined != nil}
  /// Clears the value of `dropCapShapeFillUndefined`. Subsequent reads from it will return its default value.
  mutating func clearDropCapShapeFillUndefined() {_uniqueStorage()._dropCapShapeFillUndefined = nil}
...
struct TSWPSOS_DropCapStylePropertyChangeSetArchive: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var `super`: TSWPSOS_CharacterStylePropertyChangeSetArchive {
...
struct TSWPSOS_ListStylePropertyChangeSetArchive: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var listFontColor: TSSSOS_SpecColorArchive {
  ...
  var listClassicTextIndentArray: TSWPSOS_SpecListStyleFloatArrayArchive {
  ...
  var listLabelGeometryArray: TSWPSOS_SpecListStyleListLabelGeometryArrayArchive {
  ...
  var listLabelImageDataArray: TSWPSOS_SpecListStyleImageDataArrayArchive {
  ...
  var listLabelIndentArray: TSWPSOS_SpecListStyleFloatArrayArchive {
  ...
  var listLabelNumberArray: TSWPSOS_SpecListStyleListNumberTypeArrayArchive {
  ...
  var listLabelTieredNumberArray: TSWPSOS_SpecListStyleBoolArrayArchive {
  ...
  var listLabelStringArray: TSWPSOS_SpecListStyleStringArrayArchive {
  ...
  var listTextIndentArray: TSWPSOS_SpecListStyleFloatArrayArchive {
  ...
  var listLabelTypeArray: TSWPSOS_SpecListStyleListLabelTypeArrayArchive {
...
struct TSWPSOS_ParagraphSpecificStylePropertyChangeSetArchive: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var alignment: TSSSOS_SpecIntegerArchive {
  ...
  var decimalTab: TSSSOS_SpecStringArchive {
  ...
  var defaultTabStops: TSSSOS_SpecDoubleArchive {
  ...
  var paragraphFill: TSSSOS_SpecColorArchive {
  ...
  var firstLineIndent: TSSSOS_SpecDoubleArchive {
  ...
  var followingParagraphStyle: TSWPSOS_SpecParagraphStyleArchive {
  ...
  var hyphenate: TSSSOS_SpecBoolArchive {
  ...
  var initialListStyle: TSWPSOS_SpecListStyleArchive {
  ...
  var keepLinesTogether: TSSSOS_SpecBoolArchive {
  ...
  var keepWithNext: TSSSOS_SpecBoolArchive {
  ...
  var leftIndent: TSSSOS_SpecDoubleArchive {
  ...
  var lineSpacing: TSWPSOS_SpecLineSpacingArchive {
  ...
  var outlineLevel: TSSSOS_SpecIntegerArchive {
  ...
  var outlineStyleType: TSSSOS_SpecIntegerArchive {
  ...
  var pageBreakBefore: TSSSOS_SpecBoolArchive {
  ...
  var borderPositions: TSSSOS_SpecIntegerArchive {
  ...
  var borderPositionsUndefined: Bool {
  ...
  var hasBorderPositionsUndefined: Bool {return _storage._borderPositionsUndefined != nil}
  /// Clears the value of `borderPositionsUndefined`. Subsequent reads from it will return its default value.
  mutating func clearBorderPositionsUndefined() {_uniqueStorage()._borderPositionsUndefined = nil}

  var paragraphRuleOffset: TSWPSOS_SpecRuleOffsetArchive {
  ...
  var roundedCorners: TSSSOS_SpecBoolArchive {
  ...
  var roundedCornersUndefined: Bool {
  ...
  var hasRoundedCornersUndefined: Bool {return _storage._roundedCornersUndefined != nil}
  /// Clears the value of `roundedCornersUndefined`. Subsequent reads from it will return its default value.
  mutating func clearRoundedCornersUndefined() {_uniqueStorage()._roundedCornersUndefined = nil}

  var paragraphRuleWidth: TSSSOS_SpecDoubleArchive {
  ...
  var rightIndent: TSSSOS_SpecDoubleArchive {
  ...
  var spaceAfter: TSSSOS_SpecDoubleArchive {
  ...
  var spaceBefore: TSSSOS_SpecDoubleArchive {
  ...
  var paragraphStroke: TSDSOS_SpecStrokeArchive {
  ...
  var tabs: TSWPSOS_SpecTabsArchive {
  ...
  var widowControl: TSSSOS_SpecIntegerArchive {
  ...
  var showInBookmarksList: TSSSOS_SpecBoolArchive {
  ...
  var showInTOCNavigator: TSSSOS_SpecBoolArchive {
...
struct TSWPSOS_ParagraphStylePropertyChangeSetArchive: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TSWPSOS_ShapeStylePropertyChangeSetArchive: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var `super`: TSDSOS_BaseShapeStylePropertyChangeSetArchive {
  ...
  var shrinkTextToFit: TSSSOS_SpecBoolArchive {
  ...
  var hasShrinkTextToFit: Bool {return _storage._shrinkTextToFit != nil}
  /// Clears the value of `shrinkTextToFit`. Subsequent reads from it will return its default value.
  mutating func clearShrinkTextToFit() {_uniqueStorage()._shrinkTextToFit = nil}
  ...
  var hasShrinkTextToFitUndefined: Bool {return _storage._shrinkTextToFitUndefined != nil}
  /// Clears the value of `shrinkTextToFitUndefined`. Subsequent reads from it will return its default value.
  mutating func clearShrinkTextToFitUndefined() {_uniqueStorage()._shrinkTextToFitUndefined = nil}
  ...
  var defaultParagraphStyle: TSWPSOS_SpecParagraphStyleArchive {
  ...
  var hasDefaultParagraphStyle: Bool {return _storage._defaultParagraphStyle != nil}
  /// Clears the value of `defaultParagraphStyle`. Subsequent reads from it will return its default value.
  mutating func clearDefaultParagraphStyle() {_uniqueStorage()._defaultParagraphStyle = nil}
  ...
  var hasDefaultParagraphStyleUndefined: Bool {return _storage._defaultParagraphStyleUndefined != nil}
  /// Clears the value of `defaultParagraphStyleUndefined`. Subsequent reads from it will return its default value.
  mutating func clearDefaultParagraphStyleUndefined() {_uniqueStorage()._defaultParagraphStyleUndefined = nil}
...
struct TSWPSOS_TOCEntryStylePropertyChangeSetArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var `super`: TSWPSOS_ParagraphStylePropertyChangeSetArchive {
  ...
  var tocShowPageNumber: TSSSOS_SpecBoolArchive {
  ...
  var tocPageNumberStyle: TSWPSOS_SpecCharacterStyleArchive {
...
struct TSWPSOS_StyleDiffArchive: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var characterChangeSet: TSWPSOS_CharacterStylePropertyChangeSetArchive {
  ...
  var paragraphChangeSet: TSWPSOS_ParagraphStylePropertyChangeSetArchive {
  ...
  var shapeChangeSet: TSWPSOS_ShapeStylePropertyChangeSetArchive {
...
extension TSWPSOS_SpecSetCharacterStyleArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}character_style\0\u{1}unset\0")
  ...
  static func ==(lhs: TSWPSOS_SpecSetCharacterStyleArchive, rhs: TSWPSOS_SpecSetCharacterStyleArchive) -> Bool {
...
extension TSWPSOS_SpecSetColumnsArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}columns\0\u{1}unset\0")
  ...
  static func ==(lhs: TSWPSOS_SpecSetColumnsArchive, rhs: TSWPSOS_SpecSetColumnsArchive) -> Bool {
...
extension TSWPSOS_SpecSetDropCapArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}drop_cap\0\u{1}unset\0")
  ...
  static func ==(lhs: TSWPSOS_SpecSetDropCapArchive, rhs: TSWPSOS_SpecSetDropCapArchive) -> Bool {
...
extension TSWPSOS_SpecSetFontFeaturesArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}font_features\0\u{3}font_features_undefined\0\u{1}unset\0")
  ...
  static func ==(lhs: TSWPSOS_SpecSetFontFeaturesArchive, rhs: TSWPSOS_SpecSetFontFeaturesArchive) -> Bool {
...
extension TSWPSOS_SpecSetLineSpacingArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}line_spacing\0\u{1}unset\0")
  ...
  static func ==(lhs: TSWPSOS_SpecSetLineSpacingArchive, rhs: TSWPSOS_SpecSetLineSpacingArchive) -> Bool {
...
extension TSWPSOS_SpecSetListStyleArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}list_style\0\u{1}unset\0")
  ...
  static func ==(lhs: TSWPSOS_SpecSetListStyleArchive, rhs: TSWPSOS_SpecSetListStyleArchive) -> Bool {
...
extension TSWPSOS_SpecSetListStyleBoolArrayArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}list_style_bool_array\0\u{3}list_style_bool_array_undefined\0\u{1}unset\0")
  ...
  static func ==(lhs: TSWPSOS_SpecSetListStyleBoolArrayArchive, rhs: TSWPSOS_SpecSetListStyleBoolArrayArchive) -> Bool {
...
extension TSWPSOS_SpecSetListStyleFloatArrayArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}list_style_float_array\0\u{3}list_style_float_array_undefined\0\u{1}unset\0")
  ...
  static func ==(lhs: TSWPSOS_SpecSetListStyleFloatArrayArchive, rhs: TSWPSOS_SpecSetListStyleFloatArrayArchive) -> Bool {
...
extension TSWPSOS_SpecSetListStyleImageDataArrayArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}list_style_image_data_array\0\u{3}list_style_image_data_array_undefined\0\u{1}unset\0")
  ...
  static func ==(lhs: TSWPSOS_SpecSetListStyleImageDataArrayArchive, rhs: TSWPSOS_SpecSetListStyleImageDataArrayArchive) -> Bool {
...
extension TSWPSOS_SpecSetListStyleListLabelGeometryArrayArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}list_style_list_label_geometry_array\0\u{3}list_style_list_label_geometry_array_undefined\0\u{1}unset\0")
  ...
  static func ==(lhs: TSWPSOS_SpecSetListStyleListLabelGeometryArrayArchive, rhs: TSWPSOS_SpecSetListStyleListLabelGeometryArrayArchive) -> Bool {
...
extension TSWPSOS_SpecSetListStyleListLabelTypeArrayArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}list_style_list_label_type_array\0\u{3}list_style_list_label_type_array_undefined\0\u{1}unset\0")
  ...
  static func ==(lhs: TSWPSOS_SpecSetListStyleListLabelTypeArrayArchive, rhs: TSWPSOS_SpecSetListStyleListLabelTypeArrayArchive) -> Bool {
...
extension TSWPSOS_SpecSetListStyleListNumberTypeArrayArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}list_style_list_number_type_array\0\u{3}list_style_list_number_type_array_undefined\0\u{1}unset\0")
  ...
  static func ==(lhs: TSWPSOS_SpecSetListStyleListNumberTypeArrayArchive, rhs: TSWPSOS_SpecSetListStyleListNumberTypeArrayArchive) -> Bool {
...
extension TSWPSOS_SpecSetListStyleStringArrayArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}list_style_string_array\0\u{3}list_style_string_array_undefined\0\u{1}unset\0")
  ...
  static func ==(lhs: TSWPSOS_SpecSetListStyleStringArrayArchive, rhs: TSWPSOS_SpecSetListStyleStringArrayArchive) -> Bool {
...
extension TSWPSOS_SpecSetPaddingArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}padding\0\u{1}unset\0")
  ...
  static func ==(lhs: TSWPSOS_SpecSetPaddingArchive, rhs: TSWPSOS_SpecSetPaddingArchive) -> Bool {
...
extension TSWPSOS_SpecSetParagraphStyleArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}paragraph_style\0\u{1}unset\0")
  ...
  static func ==(lhs: TSWPSOS_SpecSetParagraphStyleArchive, rhs: TSWPSOS_SpecSetParagraphStyleArchive) -> Bool {
...
extension TSWPSOS_SpecSetRuleOffsetArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}rule_offset\0\u{1}unset\0")
  ...
  static func ==(lhs: TSWPSOS_SpecSetRuleOffsetArchive, rhs: TSWPSOS_SpecSetRuleOffsetArchive) -> Bool {
...
extension TSWPSOS_SpecSetTabsArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}tabs\0\u{1}unset\0")
  ...
  static func ==(lhs: TSWPSOS_SpecSetTabsArchive, rhs: TSWPSOS_SpecSetTabsArchive) -> Bool {
...
extension TSWPSOS_SpecCharacterStyleArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}spec_set_character_style\0")
  ...
  static func ==(lhs: TSWPSOS_SpecCharacterStyleArchive, rhs: TSWPSOS_SpecCharacterStyleArchive) -> Bool {
...
extension TSWPSOS_SpecColumnsArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}spec_set_columns\0")
  ...
  static func ==(lhs: TSWPSOS_SpecColumnsArchive, rhs: TSWPSOS_SpecColumnsArchive) -> Bool {
...
extension TSWPSOS_SpecDropCapArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}spec_set_drop_cap\0")
  ...
  static func ==(lhs: TSWPSOS_SpecDropCapArchive, rhs: TSWPSOS_SpecDropCapArchive) -> Bool {
...
extension TSWPSOS_SpecFontFeaturesArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}spec_set_font_features\0")
  ...
  static func ==(lhs: TSWPSOS_SpecFontFeaturesArchive, rhs: TSWPSOS_SpecFontFeaturesArchive) -> Bool {
...
extension TSWPSOS_SpecLineSpacingArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}spec_set_line_spacing\0")
  ...
  static func ==(lhs: TSWPSOS_SpecLineSpacingArchive, rhs: TSWPSOS_SpecLineSpacingArchive) -> Bool {
...
extension TSWPSOS_SpecListStyleArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}spec_set_list_style\0")
  ...
  static func ==(lhs: TSWPSOS_SpecListStyleArchive, rhs: TSWPSOS_SpecListStyleArchive) -> Bool {
...
extension TSWPSOS_SpecListStyleBoolArrayArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}spec_set_list_style_bool_array\0")
  ...
  static func ==(lhs: TSWPSOS_SpecListStyleBoolArrayArchive, rhs: TSWPSOS_SpecListStyleBoolArrayArchive) -> Bool {
...
extension TSWPSOS_SpecListStyleFloatArrayArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}spec_set_list_style_float_array\0")
  ...
  static func ==(lhs: TSWPSOS_SpecListStyleFloatArrayArchive, rhs: TSWPSOS_SpecListStyleFloatArrayArchive) -> Bool {
...
extension TSWPSOS_SpecListStyleImageDataArrayArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}spec_set_list_style_image_data_array\0")
  ...
  static func ==(lhs: TSWPSOS_SpecListStyleImageDataArrayArchive, rhs: TSWPSOS_SpecListStyleImageDataArrayArchive) -> Bool {
...
extension TSWPSOS_SpecListStyleListLabelGeometryArrayArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}spec_set_list_style_list_label_geometry_array\0")
  ...
  static func ==(lhs: TSWPSOS_SpecListStyleListLabelGeometryArrayArchive, rhs: TSWPSOS_SpecListStyleListLabelGeometryArrayArchive) -> Bool {
...
extension TSWPSOS_SpecListStyleListLabelTypeArrayArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}spec_set_list_style_list_label_type_array\0")
  ...
  static func ==(lhs: TSWPSOS_SpecListStyleListLabelTypeArrayArchive, rhs: TSWPSOS_SpecListStyleListLabelTypeArrayArchive) -> Bool {
...
extension TSWPSOS_SpecListStyleListNumberTypeArrayArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}spec_set_list_style_list_number_type_array\0")
  ...
  static func ==(lhs: TSWPSOS_SpecListStyleListNumberTypeArrayArchive, rhs: TSWPSOS_SpecListStyleListNumberTypeArrayArchive) -> Bool {
...
extension TSWPSOS_SpecListStyleStringArrayArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}spec_set_list_style_string_array\0")
  ...
  static func ==(lhs: TSWPSOS_SpecListStyleStringArrayArchive, rhs: TSWPSOS_SpecListStyleStringArrayArchive) -> Bool {
...
extension TSWPSOS_SpecPaddingArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}spec_set_padding\0")
  ...
  static func ==(lhs: TSWPSOS_SpecPaddingArchive, rhs: TSWPSOS_SpecPaddingArchive) -> Bool {
...
extension TSWPSOS_SpecParagraphStyleArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}spec_set_paragraph_style\0")
  ...
  static func ==(lhs: TSWPSOS_SpecParagraphStyleArchive, rhs: TSWPSOS_SpecParagraphStyleArchive) -> Bool {
...
extension TSWPSOS_SpecRuleOffsetArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}spec_set_rule_offset\0")
  ...
  static func ==(lhs: TSWPSOS_SpecRuleOffsetArchive, rhs: TSWPSOS_SpecRuleOffsetArchive) -> Bool {
...
extension TSWPSOS_SpecTabsArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}spec_set_tabs\0")
  ...
  static func ==(lhs: TSWPSOS_SpecTabsArchive, rhs: TSWPSOS_SpecTabsArchive) -> Bool {
...
extension TSWPSOS_CharacterStylePropertyChangeSetArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: TSWPSOS_CharacterStylePropertyChangeSetArchive, rhs: TSWPSOS_CharacterStylePropertyChangeSetArchive) -> Bool {
...
extension TSWPSOS_ColumnStylePropertyChangeSetArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: TSWPSOS_ColumnStylePropertyChangeSetArchive, rhs: TSWPSOS_ColumnStylePropertyChangeSetArchive) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension TSWPSOS_DropCapSpecificStylePropertyChangeSetArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}drop_cap_model\0\u{3}drop_cap_model_undefined\0\u{3}drop_cap_shape_stroke\0\u{3}drop_cap_shape_stroke_undefined\0\u{3}drop_cap_shape_fill\0\u{3}drop_cap_shape_fill_undefined\0")
  ...
  static func ==(lhs: TSWPSOS_DropCapSpecificStylePropertyChangeSetArchive, rhs: TSWPSOS_DropCapSpecificStylePropertyChangeSetArchive) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension TSWPSOS_DropCapStylePropertyChangeSetArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}super\0\u{3}drop_cap_model\0\u{3}drop_cap_model_undefined\0\u{3}drop_cap_shape_stroke\0\u{3}drop_cap_shape_stroke_undefined\0\u{3}drop_cap_shape_fill\0\u{3}drop_cap_shape_fill_undefined\0")
  ...
  static func ==(lhs: TSWPSOS_DropCapStylePropertyChangeSetArchive, rhs: TSWPSOS_DropCapStylePropertyChangeSetArchive) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension TSWPSOS_ListStylePropertyChangeSetArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: TSWPSOS_ListStylePropertyChangeSetArchive, rhs: TSWPSOS_ListStylePropertyChangeSetArchive) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension TSWPSOS_ParagraphSpecificStylePropertyChangeSetArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: TSWPSOS_ParagraphSpecificStylePropertyChangeSetArchive, rhs: TSWPSOS_ParagraphSpecificStylePropertyChangeSetArchive) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension TSWPSOS_ParagraphStylePropertyChangeSetArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: TSWPSOS_ParagraphStylePropertyChangeSetArchive, rhs: TSWPSOS_ParagraphStylePropertyChangeSetArchive) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension TSWPSOS_ShapeStylePropertyChangeSetArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: TSWPSOS_ShapeStylePropertyChangeSetArchive, rhs: TSWPSOS_ShapeStylePropertyChangeSetArchive) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension TSWPSOS_TOCEntryStylePropertyChangeSetArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}super\0\u{3}toc_show_page_number\0\u{3}toc_show_page_number_undefined\0\u{3}toc_page_number_style\0\u{3}toc_page_number_style_undefined\0")
  ...
  static func ==(lhs: TSWPSOS_TOCEntryStylePropertyChangeSetArchive, rhs: TSWPSOS_TOCEntryStylePropertyChangeSetArchive) -> Bool {
...
extension TSWPSOS_StyleDiffArchive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}style\0\u{3}character_change_set\0\u{3}paragraph_change_set\0\u{3}shape_change_set\0")
  ...
  static func ==(lhs: TSWPSOS_StyleDiffArchive, rhs: TSWPSOS_StyleDiffArchive) -> Bool {
